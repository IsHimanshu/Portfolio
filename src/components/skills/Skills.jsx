          ...
          <div className="left flex-1 w-full">
            ...
            >
              <div className=" flex flex-col gap-6  w-3/4  my-5 md:w-[90%]">
                <ProgressBar logo={<IoLogoPython />} name={"Python"} value={95} />
                <ProgressBar logo={<img src = "src/components/skills/deep-learning.png" width={20}/>} name={"Machine Learning"} value={88} />
                <ProgressBar
                  logo={<SiMongodb />}
                  name={"MongoDB"}
                  value={70}
                ...
                <ProgressBar
                  logo={<img src="src/components/skills/deep-learning.png" width={20}/>}
                  name={"Deep learning"}
                  value={88}
                />
              </div>
